#!/usr/bin/env python3
"""
Christmas Piano Lights Random Sequence Controller
Runs continuous light sequences with time-based activation (5pm-11:59pm MST)
"""
...
class ChristmasLightsController:
    ...
    def sequence_random_groups(self):
        ...
        # Run for random duration (let's say between 30-60 seconds)
